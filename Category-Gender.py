...
df2 = df.get(['Product Category', 'Gender', 'Total Purchase Amount', 'NPS'])
df3 = df2.groupby(['Product Category', 'Gender']).agg({'Total Purchase Amount': 'sum', 'NPS': 'mean'})
print(df3)

### Gera um gráfico de linha mostrando as quantidades por agrupamento
df3.plot.line(subplots=True, figsize=(25, 15), stacked=False, xlabel='Product Category / Gender')
plt.savefig('Category-Gender.jpg')

df3.plot.pie(subplots=True, legend=True, figsize=(25, 10))
plt.savefig('Category-Gender-pie.jpg')
